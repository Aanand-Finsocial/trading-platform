    ...
    <div className={`min-h-screen flex flex-col ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'}`}>
        ...
        <div className="px-2 sm:px-4 py-2 overflow-x-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden sm:flex items-center space-x-6 text-sm whitespace-nowrap">
              ...
              {/* Margin-specific indicators */}
              <div className="flex items-center space-x-4">
                <span className={`text-xs ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
                  Margin Level: <span className="text-green-500">2.45</span>
                </span>
                <span className={`text-xs ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
                  Free Margin: <span className="text-blue-500">$12,450</span>
                </span>
              </div>
              {/* Desktop Only Stats */}
      ...
      <div className={`md:hidden px-2 py-2 border-b ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-gray-100 border-gray-200'}`}>
        <div className="grid grid-cols-3 gap-2 text-xs">
          ...
          <div className="text-center">
            <p className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Free Margin</p>
        ...
        <div className="hidden lg:block">
          ...
          <div className="h-[400px] border-t border-gray-700">
            <TradeForm
              ...
              onTradeSubmit={(tradeData) => console.log('Margin trade submitted:', tradeData)}
            />
          </div>
        </div>
